...
InChI layers should be generated or if just a standard InChI should be calculated. Table~\ref{tab:wrapper}
shows several Java methods of the JniInChIWrapper class.
